...
4. 诞生：Tuliko 命名的创作桥段 + SPD01 / SPD07 / SPD12 三款并列，分别对应个人专注、双人面谈、团队会议 + 非历史年表的阶段路径。当前产品明确区别于虚构的历史样机，图片不宣称同一缩尺；手机也保持三款同屏，场景说明在下方纵向排列。
...
- 生产构建通过；三尺寸展示更新后 20 项自动检查通过，新增三个既有产品素材与非轮播并列布局检查。桌面 1280px 与手机 390px 已目视确认三款并列、完整显示、无横向溢出。
