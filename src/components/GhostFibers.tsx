...
type FiberUniforms = {
  ...
  uLineColor: VectorUniform;
  uGlowColor: VectorUniform;
};
...
const setColor = (uniform: VectorUniform, hex: string) => {
...
const GhostFibers = memo(function GhostFibers({
  lineColor = "#140E35",
  glowColor = "#3437A0",
  speed = 0.2,
  scale = 2,
